...
- [FreshProxies.net](https://www.FreshProxies.net) - Simple REST API provides recently tested and working fresh public proxies. Free demo access sufficient for moderate use.
