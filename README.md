...
- [LoginRadius](https://www.loginradius.com/docs/developer/) - The developer-friendly Identity Platform provides a comprehensive set of APIs to enable authentication, identity verification, single sign-on, user management, and account protection capabilities such as multi-factor authentication on any web or mobile application.
...
- [Cloudflare Trace](https://www.cloudflare.com/cdn-cgi/trace) - Get IP Address, Timestamp, User Agent, Country Code, IATA, HTTP Version, TLS/SSL Version & More.
...
- [Mediastack](https://mediastack.com/documentation) - Scalable JSON API delivering worldwide news, headlines and blog articles in real-time.
...
- [MMO Games](https://www.mmobomb.com/api) - MMO Games database, news and giveaways.
...
- [Open-Meteo](https://open-meteo.com/en/docs) - Global weather forecast API. Free for non-commercial use. No API key required. CORS supported.
