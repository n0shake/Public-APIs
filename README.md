...
| [**Statistics of the World**](https://statisticsoftheworld.com/api-docs) | GDP, population, inflation & 440+ economic indicators for 218 countries in [JSON](https://en.wikipedia.org/wiki/JSON) format. Data from IMF, World Bank, and WHO. | **N/A** |
