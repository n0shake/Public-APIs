...
| [**Bruzu**](https://bruzu.com) |  Dynamically generate Images with a URL string. This service allows you to create dynamic images using nothing more than a URL string. To see it in action, just paste this URL into your browser's address bar: https://img.bruzu.com/?bc=yellow&a.t=Hello. Now try changing the text from "Hello" to your name.| **N/A** |
