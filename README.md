...
| [**Scrax**](https://rapidapi.com/mtaahoperators/api/scrax) | Success-only web scraping API. Credits are only charged when a scrape actually succeeds, no charge on failed requests. | 💸 |
