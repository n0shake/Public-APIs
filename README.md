...
| API | Description | Open/Trial |
| --- | ----------- | ---- |
| [**Prismix**](https://prismix.dev/api/v1/statuses) | Real-time status API for 75+ AI services (OpenAI, Anthropic, Mistral, etc.) plus AI news aggregator and MCP server directory. | **N/A** |
