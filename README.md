...
| [**TranscriptFetch**](https://transcriptfetch.com/docs) | Transcript API for YouTube, TikTok, Instagram and podcasts, returning clean text or timestamped JSON, with an MCP server for AI agents. | **N/A** |
